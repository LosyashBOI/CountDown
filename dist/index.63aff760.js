...
function updateTime(chosenDate) {
    const lessThanHour = _dateFns.isWithinInterval(Date.now(), {
        start: _dateFns.subHours(chosenDate, 1),
        end: chosenDate
    });
    if (lessThanHour) UI_ELEMENTS.OUTPUT_HOURS.textContent = 'less than hour';
    else setTimeout(createTime(chosenDate), 1000);
}
function createTime(chosenDate) {
    ...
    UI_ELEMENTS.OUTPUT_HOURS.textContent = getTime(chosenDate).minutes;
    updateTime(chosenDate);
// console.log(getTime(chosenDate).minutes)
}
function showTime(event) {
    createTime(UI_ELEMENTS.INPUT.value);
    event.preventDefault();
}
function showTimeFromStorage() {
    createTime(_storageJs.currentDate);
}
alert('something');
showTimeFromStorage();
...
},{"../toDate/index.js":"fsust","../differenceInCalendarYears/index.js":"f4WIY","../compareAsc/index.js":"h01l4","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"bjzro"}],"5hNtu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "currentDate", ()=>currentDate
);
const currentDate = localStorage.getItem('date');

},{"@parcel/transformer-js/src/esmodule-helpers.js":"bjzro"}]},["hUCxU","adjPd"], "adjPd", "parcelRequire94c2")
